...
class GridNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // if using Stack in children. decoration: BoxDecoration: borderRadius is got overlapped, useless.
    // need to use PhysicalModel to achieve borderRadius.
  ...
  _doubleItem(
    ...
    return Column(
      children: [
        // Expanded in vertical direction
  ...
  _item(BuildContext context, CommonModel item, bool first) {
    ...
    return FractionallySizedBox(
      // Expanded in horizontal direction
      widthFactor: 1,
      child: Container(
        decoration: BoxDecoration(
            border: Border(
